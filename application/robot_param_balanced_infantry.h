...
#define J0_ANGLE_OFFSET     (-0.1744f + M_PI) // (rad)关节0角度偏移量(电机0点到水平线的夹角)
#define J1_ANGLE_OFFSET     (0.1744f)         // (rad)关节1角度偏移量(电机0点到水平线的夹角)
#define J2_ANGLE_OFFSET     (0.1744f + M_PI)  // (rad)关节2角度偏移量(电机0点到水平线的夹角)
#define J3_ANGLE_OFFSET     (-0.1744f)        // (rad)关节3角度偏移量(电机0点到水平线的夹角)
...
#define MAX_SPEED_VECTOR_VY  (3.0f)
#define MAX_SPEED_VECTOR_WZ  (10.0f)
...
//yaw轴跟踪速度环PID参数
#define KP_CHASSIS_YAW_VELOCITY        (2.5f)
#define KI_CHASSIS_YAW_VELOCITY        (0.5f)
#define KD_CHASSIS_YAW_VELOCITY        (0.0f)
#define MAX_IOUT_CHASSIS_YAW_VELOCITY  (0.8f)
#define MAX_OUT_CHASSIS_YAW_VELOCITY   (2.2f)
...
#define KI_CHASSIS_ROLL_ANGLE        (0.01f)
#define KD_CHASSIS_ROLL_ANGLE        (0.2f)
#define MAX_IOUT_CHASSIS_ROLL_ANGLE  (0.05f)
...
#define KI_CHASSIS_FOLLOW_GIMBAL       (0.05f)
#define KD_CHASSIS_FOLLOW_GIMBAL       (0.0f)
#define MAX_IOUT_CHASSIS_FOLLOW_GIMBAL (1.0f)
#define MAX_OUT_CHASSIS_FOLLOW_GIMBAL  (12.0f)
