...
/**
 * @brief 速度斜坡函数，用于限制速度参考值的变化率，同时保证操作手感
 * @param spd_ref
 * @param spd_fdb
 * @param dspd_max
 * @return spd_ref_limited
 */
// float SpeedRamp(float spd_ref, float spd_fdb, float dspd_max)
// {
//     // 计算速度参考值与反馈值的差值
//     float delta_spd = spd_ref - spd_fdb;

//     // 限制速度变化率
//     if (delta_spd > dspd_max) {
//         return spd_fdb + dspd_max;
//     } else if (delta_spd < -dspd_max) {
//         return spd_fdb - dspd_max;
//     } else {
//         return spd_ref;
//     }
